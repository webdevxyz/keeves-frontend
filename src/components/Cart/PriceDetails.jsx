...
import AppiledCoupon from "./AppliedCoupon";
...
const PriceDetails = () => {
    ...
    return (
        <>
            ...
            {isApplied ? <AppiledCoupon/> : <Coupon />}
                <div className="bgWhite br10 veryLightBorder mt1">
                    <h3 className="fs18 fw400 p1 lightBorderBottom2">Price Details</h3>
                    <div className="p1">
                        ...
                        <button className="primaryBtn w100" onClick={() => navigate("/deliveryAddress")}>Buy Now</button>
                    </div>
                </div>
            </div>
        </>
